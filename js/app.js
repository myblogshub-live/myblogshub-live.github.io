(() => {
  ...
  function initGSAP() {
    ...
    if (typeof ScrollTrigger !== 'undefined') {
      registerScrollReveals(isTouch, smoothCB);
      registerScrollParallax(isTouch);
    }
  }

  function registerScrollReveals(isTouch, smoothCB) {
  ...
  function registerScrollParallax(isTouch) {
    if (isTouch) return;
